...
async function BalanceCard(){
    ...
    return <Card className="bg-gradeient-to-br from-primary/10 via-primary/5 to-background border-primary/20 shadow-lg flex justify-between flex-col overflow-hidden">
    ...
    return <Card>
        <CardHeader>
            <CardTitle className="text-2xl font-bold flex items-center gap-2">
                <ArrowLeftRightIcon size={20} className="h-6 w-6 text-primary" />
                Transaction History
            </CardTitle>
            <CardDescription>
