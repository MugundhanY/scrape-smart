...
import ExecutionsStatusIndicator from './ExecutionsStatusIndicator';
            ...
            <TableBody className='gap-2 h-full overflow-auto'>
                {query.data.map((execution) => {
                    ...
                    <TableRow key={execution.id} className='cursor-pointer' onClick={() => {
                        ...
                        <TableCell>
                            <div className='flex flex-col'>
                                <div className='flex gap-2 items-center'><ExecutionsStatusIndicator status={execution.status as WorkflowExecutionStatus} />
